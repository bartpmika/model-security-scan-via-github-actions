...
> **Note:** This example is scoped to **HuggingFace models deployed as self-hosted endpoints on Vertex AI**. MaaS (Model as a Service) models and non-HuggingFace Model Garden models are not currently supported.
